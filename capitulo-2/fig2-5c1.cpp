...
{
    if (j==1) return            +2*Omega*sech(1.763*t/Tp)*(b12*cos(alpha)-a12*sin(alpha))  +q22*a2 -(a1-a10)*gama;
    if (j==2) return            -2*Omega*sech(1.763*t/Tp)*(b12*cos(alpha)-a12*sin(alpha))  -q22*a2       -a2*gama;
    if (j==3) return -dd*b12-Omega*sech(1.763*t/Tp)*(a2-a1)*sin(alpha)                    -0.5*q22*a12  -a12*gama;
    if (j==4) return  dd*a12+Omega*sech(1.763*t/Tp)*(a2-a1)*cos(alpha)                    -0.5*q22*b12  -b12*gama;
}      
